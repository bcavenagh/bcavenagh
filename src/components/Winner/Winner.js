...
class Winner extends Component{
    ...
    render(){
        return(
            <>
            <span className={classes.svg}><svg xmlns="http://www.w3.org/2000/svg" id="firework-slide2" className={classNames(classes.firework_icon, classes.injected_svg, classes.img_firework, classes.inject_svg)} data-name="Calque 1" viewBox="0 0 157 156">
            ...
            <div className={classes.Winner}>
                <div className={classes.WinnerText}>
                    ...
                    {/* <p>Enter your name here and press submit and you will be added to the site!</p> */}
                </div>
            </div>
